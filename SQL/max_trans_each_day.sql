...
(
    select transaction_id,
        day,
        amount,
        max(amount) over (partition by day) as max_per_day_amnt
    from Transactions
)
select t.transaction_id
from Transactions t join max_tran m on t.transaction_id=m.transaction_id
where t.amount=m.max_per_day_amnt
